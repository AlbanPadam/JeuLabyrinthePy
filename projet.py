...
if __name__ == '__main__':
    ...
    # Icone de fenêtre
    icone_fenetre = pygame.image.load('images/Gloupi.png')
    ...
    wall = pygame.image.load('images/brique_neutre.png').convert()
    
    hero_down = pygame.image.load('images/julius_down.png').convert()
    hero_down.set_colorkey((0, 0, 0))

    hero_up = pygame.image.load('images/julius_up.png').convert()
    hero_up.set_colorkey((0, 0, 0))

    hero_left = pygame.image.load('images/julius_left.png').convert()
    hero_left.set_colorkey((0, 0, 0))

    hero_right = pygame.image.load('images/julius_right.png').convert()
    hero_right.set_colorkey((0, 0, 0))

    hero_down_walking1 = pygame.image.load('images/julius_down_walking1.png').convert()
    hero_down_walking1.set_colorkey((0, 0, 0))

    hero_down_walking2 = pygame.image.load('images/julius_down_walking2.png').convert()
    hero_down_walking2.set_colorkey((0, 0, 0))

    hero_up_walking1 = pygame.image.load('images/julius_up_walking1.png').convert()
    hero_up_walking1.set_colorkey((0, 0, 0))

    hero_up_walking2 = pygame.image.load('images/julius_up_walking2.png').convert()
    hero_up_walking2.set_colorkey((0, 0, 0))

    hero_right_walking1 = pygame.image.load('images/julius_right_walking1.png').convert()
    hero_right_walking1.set_colorkey((0, 0, 0))

    hero_right_walking2 = pygame.image.load('images/julius_right_walking2.png').convert()
    hero_right_walking2.set_colorkey((0, 0, 0))

    hero_left_walking1 = pygame.image.load('images/julius_left_walking1.png').convert()
    hero_left_walking1.set_colorkey((0, 0, 0))

    hero_left_walking2 = pygame.image.load('images/julius_left_walking2.png').convert()
    hero_left_walking2.set_colorkey((0, 0, 0))

    halo1 = pygame.image.load('images/halo1.png').convert()
    halo1.set_colorkey((255, 255, 255))

    halo2 = pygame.image.load('images/halo2.png').convert()
    halo2.set_colorkey((255, 255, 255))

    halo3 = pygame.image.load('images/halo3.png').convert()
    halo3.set_colorkey((255, 255, 255))

    entrance = pygame.image.load('images/entrance.png').convert()
    entrance.set_colorkey((255, 255, 255))

    exit1 = pygame.image.load('images/exit.png').convert()
    exit1.set_colorkey((255, 255, 255))

    chest1 = pygame.image.load('images/chest1.png').convert()
    chest1.set_colorkey((255, 255, 255))

    chest2 = pygame.image.load('images/chest2.png').convert()
    chest2.set_colorkey((255, 255, 255))

    chest3 = pygame.image.load('images/chest3.png').convert()
    chest3.set_colorkey((255, 255, 255))
    
    chest4 = pygame.image.load('images/chest4.png').convert()
    chest4.set_colorkey((255, 255, 255))
    
    heart = pygame.image.load('images/heart.png').convert()
    
    heart2 = pygame.image.load('images/heart2.png').convert()

    Big_title = pygame.image.load('images/Title.png').convert()
    Big_title.set_colorkey((0,0,0))

    rules = pygame.image.load('images/rules.png').convert()
    rules.set_colorkey((255,255,255))

    return_key = pygame.image.load('images/return_key.png')
    return_key.set_colorkey((0,0,0))

    arrow_keys = pygame.image.load('images/arrow_keys.png')
    arrow_keys.set_colorkey((0,0,0))
    
    main_menu=pygame.image.load('images/main_menu.png').convert()
    main_menu.set_colorkey((0,0,0))
    
    Shop_menu = pygame.image.load('images/Shop.png').convert()
    Shop_menu.set_colorkey((0,0,0))
    
    coin = pygame.image.load('images/coin.png').convert()
    ...
    for nv in range(1,11):
        ...
        lvl = open("levels/level"+str(nv)+".txt")
